...
// MARK: - SetupUI
private extension ShimmerCollectionViewCell {
    ...
    func setupShimmerEffect() {
        ...
        newsArticleTitle.isSkeletonable = true
        newsArticleTitle.showAnimatedGradientSkeleton()
        
        shareImage.isSkeletonable = true
        shareImage.skeletonCornerRadius = 12
        shareImage.showAnimatedGradientSkeleton()
        
        newsArticleImage.isSkeletonable = true
        newsArticleImage.skeletonCornerRadius = 8
    ...
    func stopShimmer() {
        ...
        newsArticleTitle.hideSkeleton()
        newsArticleImage.hideSkeleton()
        newsDate.hideSkeleton()
    }
}
